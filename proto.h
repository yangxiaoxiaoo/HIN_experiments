...
(const graph_t& g, Query_tree querytree, std::unordered_map<int,  std::unordered_map<int, std::vector<int>>> & candidxleft, std::unordered_map<int, std::unordered_map<int, std::vector<int>>> & candidxright);
